...
class categoryClass:
    def __init__(self,root):
        ...
        #=========title======
        b1_title=Label(self.root,text="Manage Product Category",font=("goudy old style",30),bg="#184a45",fg="white",bd=3,relief=RIDGE).pack(side=TOP,fill=X,padx=10,pady=20)

        b1_name=Label(self.root,text="Enter Category Name",font=("goudy old style",30),bg="white").place(x=50,y=100)
        ...
        btn_delete=Button(self.root,text="Delete",command=self.delete,font=("goudy old style",15),bg="orange",fg="white",cursor="hand2").place(x=520,y=170,width=150,height=30)
