...
class employeeClass:
    def __init__(self,root):
        ...
        #======content================
        #====row1=====================
        b1_empid=Label(self.root,text="Emp ID",font=("goudy old style",15),bg="white").place(x=50,y=150)
        b1_gender=Label(self.root,text="Gender",font=("goudy old style",15),bg="white").place(x=350,y=150)
        b1_contact=Label(self.root,text="Contact",font=("goudy old style",15),bg="white").place(x=750,y=150)
        ...
        cmb_gender=ttk.Combobox(self.root,textvariable=self.var_searchby,values=("Select","Male","Female","Time to not say","Other"),state='readonly',justify=CENTER,font=("time new roman",15))
        ...
        b1_name=Label(self.root,text="Name",font=("goudy old style",15),bg="white").place(x=50,y=190)
        b1_dob=Label(self.root,text="D.O.B",font=("goudy old style",15),bg="white").place(x=350,y=190)
        b1_doj=Label(self.root,text="D.O.J",font=("goudy old style",15),bg="white").place(x=750,y=190)
        ...
        txt_doj_=Entry(self.root,textvariable=self.var_doj,font=("goudy old style",15),bg="lightyellow").place(x=850,y=190,width=180)

         #====row3========

        b1_email=Label(self.root,text="Email",font=("goudy old style",15),bg="white").place(x=50,y=230)
        b1_password=Label(self.root,text="Password",font=("goudy old style",15),bg="white").place(x=350,y=230)
        b1_utype=Label(self.root,text="User Type",font=("goudy old style",15),bg="white").place(x=750,y=230)
        ...
        cmb_utype=ttk.Combobox(self.root,textvariable=self.var_utype,values=("Admin","Employee","Intern"),state='readonly',justify=CENTER,font=("time new roman",15))
        cmb_utype.place(x=850,y=230,width=180)
        cmb_utype.current(0)

        #====row3========

        b1_address=Label(self.root,text="Address",font=("goudy old style",15),bg="white").place(x=50,y=270)
        b1_salary=Label(self.root,text="Salary",font=("goudy old style",15),bg="white").place(x=500,y=270)
