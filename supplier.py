...
class supplierClass:
    def __init__(self,root):
        ...
        #=====SearchFrame===
        #====Options===
        b1_search=Label(self.root,text="Invoice No.",bg="white",font=("time new roman",15))
        b1_search.place(x=700,y=80)
        ...
        #======content================
        #====row1=====================
        b1_supplier_invoice=Label(self.root,text="Invoice No.",font=("goudy old style",15),bg="white").place(x=50,y=80)
        ...
        b1_name=Label(self.root,text="Name",font=("goudy old style",15),bg="white").place(x=50,y=120)
        txt_name=Entry(self.root,textvariable=self.var_name,font=("goudy old style",15),bg="lightyellow").place(x=180,y=120,width=180)
         #====row3========

        b1_contact=Label(self.root,text="Contact",font=("goudy old style",15),bg="white").place(x=50,y=160)
        ...
        b1_desc=Label(self.root,text="Description",font=("goudy old style",15),bg="white").place(x=50,y=200)
...
#=========================================================================================================
    ...
    def search(self):
        ...
        try:
            ...
            row=cur.fetchone()
            if row!=None:
               self.supplierTable.delete(*self.EmployeeTable.get_children())
               self.supplierTable.insert('',END,values=row)
            else:
